      ...
      <SafeAreaView className="bg-neutral-100 dark:bg-neutral-900">
        ...
        <ScrollView
          ...
          <View className="flex justify-center align-left mt-5">
            ...
            {isAdmin? 
              <SelectDropdown  data={salonesList} 
              key={currentSalon}
              buttonTextStyle={{
                marginRight: -14,
                fontWeight: 'bold',
              ...
              onSelect={(salon: SalonAPI) => changeSalon(salon)} defaultButtonText={currentSalon} />
            : <Text className="justify-center text-neutral-500 font-bold m-auto mt-0 text-xl">
            {currentSalon}
          </Text>}
            
            <View style={{width: (Dimensions.get('window').width / 12) * 10}} className="flex flex-row m-auto h-[68vh] mt-3 align-middle rounded-xl bg-neutral-100  dark:bg-neutral-900">

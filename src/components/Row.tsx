...
export default function Row(presenter: Presenter) {
  return (
    <View className="flex flex-row min-h-max marker:mt-5 rounded-xl p-2 border-l-2 border-r-2 divide-x-2 bg-fl-bg divide-fl-dg border-fl-dg shadow dark:shadow-none shadow-neutral-500 dark:divide-fl-dg dark:border-fl-g  dark:bg-neutral-800 ">

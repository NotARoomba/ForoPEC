...
async function main() {
  ...
  const allowedOrigins = [
    'http://localhost:3000',
    'https://focusly.notaroomba.xyz',
    'https://notaroomba.xyz',
    'http://focusly.notaroomba.xyz',
    'https://focusly.awangran.repl.co',
  ];
  ...
  app.post('/user', async (req, res) => {
    ...
    if (user != null) {
      ...
      return res.send("That user doesn't exist!");
    }
  });
